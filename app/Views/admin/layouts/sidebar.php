<div id="sidebar-menu">
    ...
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
            <a href="javascript: void(0);" class="has-arrow waves-effect"><i
                    class="mdi mdi-table-merge-cells"></i><span>Invester Master</span></a>
            <ul class="sub-menu" aria-expanded="false">
                <li><a href="<?= base_url() ?>admin/user-list">User List</a></li>
                <li><a href="<?= base_url() ?>admin/company-details">Company Details</a></li>
                <li><a href="<?= base_url() ?>admin/invester">Invests Details</a></li>
            </ul>
        </li>
        <li>
